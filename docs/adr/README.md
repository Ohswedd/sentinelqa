...
| [0010](./0010-discovery-mvp-http-first.md)                | Discovery release is HTTP-first; Playwright SPA crawl lands in                                                                                                 | `Accepted` | 05    |
...
| [0033](./0033-cloud-boundary.md)                          | Cloud boundary — no SentinelQA cloud in the release                                                                                                            | `Accepted` | 27    |
...
| [0047](./0047-public-release-readiness.md)                | Public release readiness — README polish, GH community files, license + NOTICE audit, docs deploy, brand, branch protection, Dependabot, go-public checklist   | `Accepted` | 35    |
| [0048](./0048-publish-pipeline.md)                        | Publish pipeline — four owner-approved workflows (PyPI Trusted Publisher, npm provenance, Docker Hub multi-arch, GitHub Release) + matching dry-runs + runbook | `Accepted` | 36    |
