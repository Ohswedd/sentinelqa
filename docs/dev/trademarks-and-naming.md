...
| ---------------------------------------------------- | ------------------------- | ---------- | ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PyPI registry                                        | **Clear**                 | 2026-05-30 | Phase 28 verdict commit | `https://pypi.org/simple/sentinelqa/` returned HTTP 404; no package named `sentinelqa` is published.                                                                                                                                                                                                                         |
| npm registry (unscoped)                              | **Clear**                 | 2026-05-30 | Phase 28 verdict commit | `https://registry.npmjs.org/sentinelqa` returned HTTP 404; no package named `sentinelqa` is published.                                                                                                                                                                                                                       |
| npm registry (`@sentinelqa/*` scope)                 | **Clear**                 | 2026-05-30 | Phase 28 verdict commit | `https://registry.npmjs.org/@sentinelqa/ts-runtime` returned HTTP 404; scope unclaimed.                                                                                                                                                                                                                                      |
| GitHub project name (`site:github.com "SentinelQA"`) | **Clear**                 | 2026-05-30 | Phase 28 verdict commit | No public GitHub repository named "SentinelQA" returned by site-scoped web search. Adjacent-but-distinct projects (Azure Sentinel, SentinelOne, sentinel-official, sentinel-hub, alienator88/Sentinel, SentineLabs, nintexplatform/sentinel) are in security or apparently unrelated domains and do not use the "QA" suffix. |
| General web common-law usage                         | **Clear**                 | 2026-05-30 | Phase 28 verdict commit | A targeted web search for `"SentinelQA"` returned no project, company, or product literally using that name.                                                                                                                                                                                                                 |
...
- Stop the pending tag (Task 28.06 blocker fires).
...
- **Sub-product names.** Each major-feature codename (e.g. for a Phase 30+ cloud offering, an MCP server brand) must be re-cleared on its own.
