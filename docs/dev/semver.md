...
This page is the contract for how SentinelQA versions its published artefacts. It is read alongside `docs/dev/schema-versioning.md` (which governs the integer-major versions baked into every JSON artifact) and the SDK API snapshot at `packages/python-sdk/api-snapshot.json` (Phase 16). Skipping any rule here is a our engineering rules
...
After the first **1.0.0** tag, classic SemVer applies: breaking changes require a major bump, additive changes a minor, fixes a patch. Promotion criteria for 1.0.0 are listed in and the pre-1.0 review (Task 28.06).
...
The release calendar is driven by the engineering milestones in our product spec and the recommended build order in our product spec Each tag is a real artifact produced by `make build-all` and inspected by `make inspect-all` (Task 28.04). No tag is published without a sign-off line in `docs/release/pre-1.0-review.md` (Task 28.06).

| Tag      | When                                  | Captures                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------- | ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v0.1.0` | After Phase 17 (CI Integration)       | MVP: domain models + CLI + lifecycle + reporter pipeline + TS runtime + discovery + planner + generator + runner + analyzer + functional / accessibility / performance / security / quality scoring / HTML+JSON reports / SDK / CI integration. our product spec MVP.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `v0.2.0` | After Phase 19 (LLM-code audit)       | Adds MCP & Agent Interface (Phase 18) and the LLM-code audit module (Phase 19) — the public differentiator (the documentation, §28).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
**Phase 28 itself produces no tag.** The phase ships the release-engineering surface; the actual tagging is gated on a human-owner go-ahead.
