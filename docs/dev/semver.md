...
| `v0.7.0` | After Phase 28 (this phase) | Adds the release-engineering surface — semver policy, changelog, package metadata, distribution scripts, trademark verdict, pre-1.0 review checklist. **No publication yet.** |
| `v1.0.0` | After Phase 29 (Final Hardening & PRD Reconciliation) | First publication-eligible tag. Requires explicit human-owner go-ahead per `CLAUDE.md` §40. |
