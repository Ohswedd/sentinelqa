...
The module exercises the documentation capabilities: response-header hygiene,
...
our engineering rules + §26 every probe goes through :func:`SafetyPolicy.enforce`
