...
- `python-sdk/` — the public Python SDK (`Sentinel`, `AuditResult`, etc.; our product spec, Phase 16).
...
- `shared-schema/` — JSON Schema sources for `findings.json`, `score.json`, `run.json`, etc. (our product spec, §20; Phase 03).
