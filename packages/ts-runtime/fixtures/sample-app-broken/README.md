...
- The hint paragraph claims "Use any email to continue." but the form's submit handler is missing (no JS), so a real test against the rendered outcome surfaces the inconsistency flags.
