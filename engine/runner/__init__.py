...
the JSONL event stream emitted by the TS reporter into a
...
producing a flake-rate metric the quality-score module
consumes.
...
``sentinel test`` command drives the runner directly.
