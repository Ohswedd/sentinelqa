...
| `llm-broken/`         | Intentionally broken Next.js — drives the Phase 19 / 26.06 LLM-audit demo | `127.0.0.1:3030` | `make demo-llm-broken` |
| `end-to-end-demo/`    | `docker compose` stack tying `nextjs/` + `fastapi/` together              | `127.0.0.1:3000` | `make demo`            |
| `mcp-claude-desktop/` | Claude Desktop MCP config + walkthrough (Phase 18)                        | —                | —                      |
| `plugins/`            | Reference plugins (Phase 24)                                              | —                | —                      |
